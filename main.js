...
$(function() {
  ...
  // 新增/編輯/刪除按鈕圖示與樣式
  $('#saveEvent').addClass('btn-primary btn-icon').text('').append('<span class="icon">＋</span>儲存');
  $('#cancelEvent').addClass('btn-secondary btn-icon').text('').append('<span class="icon">✖️</span>取消');
  $('#editEvent').addClass('btn-primary btn-icon').text('').append('<span class="icon">✏️</span>編輯');
  $('#deleteEvent').addClass('btn-secondary btn-icon').text('').append('<span class="icon">🗑️</span>刪除');
  $('#closeViewEvent').addClass('btn-secondary btn-icon').text('').append('<span class="icon">✖️</span>關閉');
